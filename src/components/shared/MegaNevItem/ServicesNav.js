                ...
                <ul className="mt-1 text-[15px]">
                  ...
                  <li className="p-2 hover:bg-[#ff303018] rounded ">
                    <Link href="/about">
                      ...
                      <div className="text-xs  font-light   ">
                        Zaimah Technologies specializes in developing
                        tailor-made software solutions for businesses, including
                  ...
                  <li className="p-2 hover:bg-[#ff303018] rounded ">
                    <Link href="/about">
                      ...
                      <div className="text-xs  font-light   ">
                        Developing robust enterprise-level software systems that
                        enhance operational efficiency and business processes.
                      </div>
                    </Link>
                  </li>
                  <p className="uppercase tracking-wider text-gray-500 font-medium text-[13px] border-b-[1px] my-3 py-2">
                  ...
                  <li className="p-2 hover:bg-[#ff303018] rounded ">
                    <Link href="/about">
                      ...
                      <div className="text-xs  font-light  ">
                        Offering expert advice on how businesses can optimize
                        their IT infrastructure and processes to achieve better
                        results.
                      </div>
                    </Link>
                  </li>
                  <li className="p-2 hover:bg-[#ff303018] rounded ">
                    <Link href="/about">
                      ...
                      <div className="text-xs  font-light  ">
                        Conducting detailed IT audits to assess the performance
                        and security of existing systems, identifying areas for
                        improvement.
                      </div>
                    </Link>
                  </li>
                ...
                <ul className="mt-1 text-[15px]">
                  ...
                  <li className="p-2 hover:bg-[#ff303018] rounded ">
                    <Link href="/about">
                      ...
                      <div className="text-xs  font-light   ">
                        Assisting businesses in migrating their operations to
                        the cloud, ensuring smooth transitions and minimal
                        downtime.
                      </div>
                    </Link>
                  </li>
                  <li className="p-2 hover:bg-[#ff303018] rounded ">
                    <Link href="/about">
                      ...
                      <div className="text-xs  font-light   ">
                        Providing ongoing support and management of cloud
                        environments to ensure they remain secure, efficient,
                        and scalable.
                      </div>
                    </Link>
                  </li>
                  ...
                  <li className="p-2 hover:bg-[#ff303018] rounded ">
                    <Link href="/about">
                      ...
                      <div className="text-xs  font-light  ">
                        Offering services to protect businesses from cyber
                        threats, including real-time threat detection and
                        response.
                      </div>
                    </Link>
                  </li>
                  <li className="p-2 hover:bg-[#ff303018] rounded ">
                    <Link href="/about">
                      ...
                      <div className="text-xs  font-light  ">
                        ...
                        safeguard sensitive information from breaches and
                        unauthorized access.
                      </div>
                    </Link>
                  </li>
